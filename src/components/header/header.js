...
const Header=()=>{
  ...
  const { getUserDetails,removeToken } = useAuthStore();
      ...
      <div className="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
        ...
        <div className="hidden sm:block">
          ...
          <div className="relative">
            ...
            <input type="text" id="icon" name="icon" className="py-2 px-4 pl-11 block w-full border border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 " placeholder="Search"/>
          </div>
        </div>
          ...
          <div className="hs-dropdown relative inline-flex [--placement:bottom-right]">
            ...
            <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg p-2 " aria-labelledby="hs-dropdown-with-header">
              <div className="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg ">
                ...
                <p className="text-sm font-medium text-gray-800">{token?.userId?.email}</p>
              </div>
