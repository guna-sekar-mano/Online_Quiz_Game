...
const ActionTemplate=(props)=>{
  const {edittable,rowData,deleteconfirm}=props;
    return (
       <div className="hs-dropdown relative inline-flex">
        ...
        <div className="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] hs-dropdown-open:opacity-100 opacity-0 w-32 hidden z-10 mt-2 min-w-[15rem] bg-white shadow rounded-lg p-2" aria-labelledby="hs-dropdown-default">
          ...
          <a onClick={()=>deleteconfirm(rowData._id)} className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 " href="#">
