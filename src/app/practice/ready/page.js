        ...
        <div className="max-w-[80rem] w-full mx-auto px-6  sm:px-6 lg:px-8">
             ...
             <div className="grid grid-cols-1">
                 <div className="flex flex-col justify-center items-center text-center">
                  ...
                  <h1 className="text-white text-4xl lg:text-5xl italic [text-shadow:_0_3px_0_rgb(0_0_0_/_20%)] animate-fade-left animate-once">ARE YOU READY?</h1>
                  ...
                  <Link href={`/practice/play?t=${params.get('c')}`} onClick={inittest} className="mt-5 text-6xl italic [text-shadow:_0_3px_0_rgb(0_0_0_/_20%)] animate-fade-left animate-once animate-delay-1000">Start</Link>
                  </div>
